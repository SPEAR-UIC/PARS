...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Preprocess TIGER-Lab/MATH-plus and generate pairwise train/val data."
    )
    ...
    parser.add_argument("--train-num-pairs", type=int, default=10, help="Pairs per sample for train split.")
    parser.add_argument("--val-num-pairs", type=int, default=10, help="Pairs per sample for val split.")
...
def main():
    ...
    ds = load_dataset("TIGER-Lab/MATH-plus")["train"]
